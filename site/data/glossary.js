...
export const GLOSSARY = [
  ...
  },
  {
    ...
    fullPl: "Stosunek dawki do masy ciała: milgramy leku na kilogram wagi. Dawka całkowita (mg) = mg/kg × waga (kg). Bez zważenia nie da się obliczyć bezpiecznej dawki.",
  ...
  },
  {
    ...
    simplePl: "Lek, który dla jednego zwierzęcia jest lekiem, a dla innego (inny gatunek) - trucizną. Np. paracetamol dla człowieka OK, dla kota trucizna.",
  ...
  },
  {
    ...
    fullPl: "Malassezia to drożdżaki bytujące w przewodzie słuchowym; ich namnożenie (w ciągłym wilgotnym uchu) powoduje zapalenie ucha, swędzenie i ciemną wydzielinę. Rozpoznanie: cytologia.",
  ...
  },
  {
    ...
    fullPl: "Anemia (niedokrwistość) to stan, w którym krew ma za mało erytrocytów lub hemoglobiny, by przenieść wystarczająco tlenu. W babeszjozie powstaje hemolitycznie - pierwotniak niszczy krwinki; objawem są blade śluzówki i osowiałość.",
  ...
  },
  {
    ...
    fullPl: "Czas nawrotu kapilarnego (CRT, capillary refill time) to prosta próba perfuzji: naciskasz palcem na dziąsło (lub wargę), zwalniasz i liczysz, w ile sekund różowy kolor wraca. Prawidłowo poniżej 2 sekund. Wydłużony (powyżej 2–3 s) lub brak nawrotu oznacza słabe dotlenienie tkanek - najczęściej z powodu odwodnienia, wstrząsu, anemii lub niewydolności krążenia. Szybki, bezkosztowy wskaźnik stanu pacjenta używany w badaniu ogólnym.",
  ...
  },
  {
    ...
    fullPl: "Kość udowa (femur) to najsilniejsza i najdłuższa kość kończyny tylnej psa i kota. Złamanie femur często jest przemieszczające (odłamy rozsuwane przez mięśnie) i wymaga stabilizacji operacyjnej (osteosynteza: płytki, szpikulce) lub, w wybranych przypadkach, unieruchomienia zachowawczego. Urazy femur powstają w wyniku potrącenia lub upadku z wysokości.",
  ...
  },
  {
    ...
    fullPl: "Owrzodzenie rogówki to ubytek nabłonka rogówki (przezroczystej przedniej warstwy oka). Wykrywa je test fluoresceinowy: barwnik wije się w uszkodzone nabłonki i świeci na zielono. U kota dendrytyczne (gałęziaste) owrzodzenia rogówki są patognomoniczne dla herpeswirusa kota (FHV-1). Nieleczone mogą zagrażać wzroku, dlatego badanie okulistyczne jest kluczowe przy katarze kocim.",
  ...
  },
  {
    ...
    forms: ["pH"],
    simplePl: "Liczy, jak kwaśne lub zasadowe jest coś - na przykład mocz. 7 to obojętne, poniżej kwaśne, powyżej zasadowe.",

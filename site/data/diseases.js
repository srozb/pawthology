...
export const diseases = [
  ...
  },
  {
    ...
    bacterialInfection: false,
    optionalExams: ["physical-exam"],
    infoPl: "Biegunka pasożytnicza to biegunka, w której winowajcą nie jest dieta ani bakteria, lecz pasożyty - najczęściej nicienie takie jak Toxocara (glista). Częsta u kotów wychodzących i psów bez odrobaczania: jaja pasożytów są w glebie, a zwierzę łapie je, liżąc łapy lub jedząc trawę.\n\nCechą pasożyty jest to, że nie widać ich gołym okiem - dorosłe robaki bywają w wymiocinach lub kale, ale jaja są mikroskopijne. Dlatego rozstrzygającym badaniem jest badanie kału: pod mikroskopem widać charakterystyczne jaja. To ono rozdziela biegunkę od pasożytów od biegunki od bakterii - a to dwa zupełnie różne leczenia.\n\nLeczy się odrobaczaniem (np. fenbendazol - benzimidazol w serii 3 dni), NIE antybiotykiem. Antybiotyk nie działa na robaki i niszczy florę jelitową, która właśnie uszkodzona przez pasożyty potrzebuje spokoju. To klasyczna lekcja: najpierw zidentyfikuj winowajcę, potem dobierz lek, który go trafia.",
  ...
  {
    id: "feline-cystitis",
    labelPl: "Schorzenie dolnych dróg moczowych kota (FLUTD)", labelEn: "Feline lower urinary tract disease (FLUTD)",
    ...
    },
{
      ...
      "optionalExams": [],
      "infoPl": "Metaldehyd to składnik trutki na ślimaki i ślimaczki — silnie toksyczny dla psów i kotów. Powoduje ślinotok, niepokój, drgnienia mięśniowe, a następnie drgawki i hipertermię. Nie ma odtrutki.\n\nLeczenie to dekontaminacja: wywołanie wymiotów TYLKO gdy spożycie było niedawne (<1–2 h) i pacjent jest bezobjawowy (bez drgnieć, bez objawów neurologicznych). Gdy objawy już wystąpiły, wymioty są przeciwwskazane (ryzyko zachłyśnięcia) i leczenie sprowadza się do płynów, chłodzenia i kontroli drgawek.\n\nKluczowa lekcja toksykologiczna: kot NIE jest małym psem. Apomorfina — standardowy lek wymiotny u psa — u kota jest nieskuteczna lub niebezpieczna. U kota stosuje się agonistę alfa-2 (ksylazyna, deksmedetomidyna). Antybiotyk, NSAID i opioid są przeciwwskazane — to nie infekcja, leki maskują objawy i obciążają nerki i wątrobę.\n\nZatrucie metaldehydem uczy, że czas jest lekiem: wczesna dekontaminacja ratuje życie, a spóźnione objawy oznaczają hospitalizację. Profilaktyka to trzymanie trutki z dala od zwierząt.",

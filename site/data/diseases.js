...
},
{
  ...
  "infoEn": "Purely mechanical beak overgrowth is rare — the beak grows faster than it wears, with no mites and no deficiency — e.g. a bad bite, no hard items to wear against. Treatment is beak trimming alone, no drug.\n\nIn the game a distractor for scaly face mites — overgrowth overlaps, but there are no crusts, no itching, and no mites in the scrape. The error is trimming without examining — a hidden scaly face mite infestation returns, because the mites keep causing the beak to overgrow.",

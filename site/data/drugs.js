...
export const drugs = [
  ...
  },
  {
    ...
    tooltipEn: "Iodine antiseptic; cats absorb iodine through the skin — caution, not on large wounds.",
    routePl: "miejscowo", routeEn: "topical",
    dosingType: "topical",
    dosing: {
  ...
  },
  {
    ...
    infoEn: "Enrofloxacin is a fluoroquinolone — a reserve antibiotic with strong action on aerobic bacteria, including Pseudomonas. It is used when first-line antibiotics fail, because resistance to it is rare.\n\nIt has two important age- and species-related limits: in young, growing animals it damages joint cartilage, so it is avoided in puppies and kittens. In cats high doses are retinotoxic — they can damage the retina, so cat dosing is strict. Its advantage is that, unlike β-lactams, it is used in rabbits cautiously with justification.\n\nIt is a reserve drug — not for every bacterial infection. Justified for resistant cases, but given casually it drives resistance (AMR), and in the young and in cats it carries a risk that must be weighed against the benefit.",
  ...
  },
  {
    ...
    infoEn: "Emodepside is an antiparasitic in a spot-on form — it is applied to the skin of the neck, not orally. It acts on nematodes in cats, which is convenient for animals hard to pill.\n\nIt is applied as a drop to the neck skin, where it absorbs and distributes. It works for several weeks. For a cat that fights a tablet, it is often the only practical route for deworming.\n\nEmodepside is not an antibiotic — it does not drive bacterial resistance (AMR). It works only on nematodes, so before giving it, confirm through a fecal exam that they are indeed the culprit.",
    ...
    },
{
    ...
    },
  {
    ...
    "tooltipEn": "Oral calcium preparation for MBD in reptiles — replenishes the deficiency and mineralizes bones and shell.",
    "routePl": "p.o.",
    "routeEn": "oral",
    "dosingType": "systemic",
    "dosing": {

...
| C-SPC-07 | Species: tortoise (Hermann's) — ectothermic; needs UVB for D3 synthesis and calcium absorption; ivermectin toxic (crosses blood-brain barrier) | Verified | S-MVM | O-04,O-05 | reptile husbandry; chelonian drug sensitivity | species tortoise | draft | — |
| C-DIS-23 | Disease: metabolic bone disease (MBD) — calcium/vit D3 deficiency from lack of UVB; soft shell, pyramiding; reversible with correction; antibiotic contraindicated | Verified | S-MVM | O-04 | metabolic, not infectious | disease metabolic-bone-disease | draft | — |
| C-DRG-24 | Calcium carbonate oral 100–300 mg/kg for MBD in tortoises; replenishes calcium for bone/shell mineralization | Verified | S-MVM | O-04 | oral supplement | drug calcium-carbonate (tortoise dosing) | draft | — |
| C-DRG-25 | Vitamin D3 (cholecalciferol) 100–400 IU PO weekly for MBD; enables intestinal calcium absorption; requires UVB for endogenous synthesis | Verified | S-MVM | O-04 | oral supplement | drug vitamin-d3 (tortoise dosing) | draft | — |
| C-CASE-17 | Case: metabolic bone disease (MBD) in Hermann's tortoise Shelldon — soft shell, lethargy, limb weakness; no UVB, lettuce-only diet | Fictionalized | — | O-04,O-05 | presentation | case-tortoise-mbd | — | — |
| C-SPC-08 | Species: ferret — obligate carnivore, fast metabolism; insulinoma is the most common cancer (ages 4-5); fasting hypoglycemia episodes | Verified | S-MVM | O-04,O-05 | mustelid predator; endocrine predisposition | species ferret | draft | — |
| C-DIS-24 | Disease: insulinoma — beta-cell pancreatic tumor secreting insulin -> hypoglycemia; fasting glucose <60 mg/dL; palliative (prednisolone/diazoxide); antibiotic contraindicated | Verified | S-MVM | O-04 | endocrine, not infectious | disease insulinoma | draft | — |
| C-DRG-26 | Prednisolone 0.5-2 mg/kg PO BID in ferrets for insulinoma; glucocorticoid stimulating gluconeogenesis -> raises blood glucose; palliative | Verified | S-MVM | O-04 | oral systemic | drug prednisolone (ferret dosing) | draft | — |
| C-DRG-27 | Diazoxide 5-30 mg/kg PO q12h in ferrets for insulinoma; opens K-ATP channels in beta cells -> inhibits insulin release; second-line, expensive | Verified | S-MVM | O-04 | oral systemic | drug diazoxide (ferret dosing) | draft | — |
| C-CASE-18 | Case: insulinoma in ferret Luna — hind-leg weakness, drooling, collapse after fasting; fasting glucose 38 mg/dL; prednisolone controls hypoglycemia | Fictionalized | — | O-04,O-05 | presentation | case-ferret-insulinoma | — | — |
...
| C-SPC-09 | Species: snake (corn snake) — ectothermic reptile; metabolism and immunity depend on ambient temperature; slow metabolism (dosing q24-48h); most diseases are husbandry-related (cold, poor hygiene) | Verified | S-MVM | O-04,O-05 | ectothermic reptile; husbandry-dependent disease | species snake | draft | — |
| C-DIS-25 | Disease: infectious stomatitis (mouth rot) — bacterial infection of oral mucosa in snakes; Gram-negative (Pseudomonas); caseous debris, drooling, anorexia; treat with debridement + antiseptic (chlorhexidine) + antibiotic (enrofloxacin); antibiotic indicated (bacterial) | Verified | S-MVM | O-04 | bacterial infection; husbandry-related | disease infectious-stomatitis | draft | — |
| C-CASE-19 | Case: infectious stomatitis (mouth rot) in corn snake Vader — off food 2 weeks, drooling, caseous mass in mouth; cool terrarium (broken heater, no heat mat) | Fictionalized | — | O-04,O-05 | presentation | case-snake-mouth-rot | — | — |
